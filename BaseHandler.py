# This is the base handler. All handler in the project should inherit from this
# handler. This base handler follow the code in the Facebook API example appengine.

import os
# dummy config to enable registering django template filters
from Facebook import Facebook
from Facebook import CsrfException
